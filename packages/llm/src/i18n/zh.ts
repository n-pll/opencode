...
export const dict: Partial<Record<Keys, string>> = {
  ...
  "llm.llm.generateobject-model-did-not-call-the-forced-tool": "",
  "llm.llm.generateobject-tool-input-failed-schema-decode": "",
  "llm.tool_runtime.invalid-tool-input": "",
  "llm.tool_runtime.tool-returned-an-invalid-value-for-its-success-schema": "",
  "llm.auth.failed-to-resolve-auth-config": "",
  "llm.client.route-model-requires-a-provider": "",
  "llm.client.route-model-requires-an-endpoint-baseurl-configure-it-on-the": "",
  "llm.websocket.unsupported-websocket-url-protocol": "",
}
