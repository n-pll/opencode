...
export type EnterpriseI18nKey = keyof typeof en
...
export const t = (key: EnterpriseI18nKey, params?: I18nParams) => translate(en, active, key, params)
export const enterpriseLocale = locale
