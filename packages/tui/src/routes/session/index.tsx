...
export function Session() {
  ...
  createEffect(() => {
    ...
    void (async () => {
      ...
      if (!result.data) {
        toast.show({
          message: t("tui.index.session-not-found", { sessionID: sessionID }),
          variant: "error",
          duration: 5000,
        })
        navigate({ type: "home" })
  ...
  const sessionCommandList = createMemo(() => [
      ...
      run: async () => {
        const copy = (url: string) =>
          clipboard
            ...
            .catch(() => toast.show({ message: t("tui.index.failed-to-copy-url-to-clipboard"), variant: "error" }))
        ...
        await sdk.client.session
          ...
          .catch((error) => {
            toast.show({
              message: error instanceof Error ? error.message : t("tui.index.failed-to-share-session"),
              variant: "error",
            })
          })
        dialog.clear()
    ...
    {
      title: t("tui.index.rename-session"),
    ...
    {
      title: t("tui.index.jump-to-message"),
    ...
    {
      title: t("tui.index.compact-session"),
      ...
      run: () => {
        ...
        if (!selectedModel) {
          toast.show({
            variant: "warning",
            message: t("tui.index.connect-a-provider-to-summarize-this-session"),
            duration: 3000,
          })
          return
        }
    ...
    {
      title: t("tui.index.unshare-session"),
      ...
      run: async () => {
        await sdk.client.session
          ...
          .then(() => toast.show({ message: t("tui.index.session-unshared-successfully"), variant: "success" }))
          .catch((error) => {
            toast.show({
              message: error instanceof Error ? error.message : t("tui.index.failed-to-unshare-session"),
              variant: "error",
            })
          })
        dialog.clear()
    ...
    {
      title: t("tui.index.undo-previous-message"),
      value: "session.undo",
      category: "Session",
      slash: {
        name: "undo",
    ...
    {
      title: t("tui.index.toggle-session-scrollbar"),
    ...
    {
      title: t("tui.index.half-page-down"),
    ...
    {
      title: t("tui.index.first-message"),
      value: "session.first",
      category: "Session",
      hidden: true,
      run: () => {
    ...
    {
      title: t("tui.index.jump-to-last-user-message"),
    ...
    {
      title: t("tui.index.previous-message"),
    ...
    {
      title: t("tui.index.copy-last-assistant-message"),
      value: "messages.copy",
      category: "Session",
      run: () => {
        const lastAssistantMessage = messagesBeforeRevert().findLast((message) => message.role === "assistant")
        if (!lastAssistantMessage) {
          toast.show({ message: t("tui.index.no-assistant-messages-found"), variant: "error" })
          dialog.clear()
          return
        }
        ...
        if (textParts.length === 0) {
          toast.show({ message: t("tui.index.no-text-parts-found-in-last-assistant-message"), variant: "error" })
          dialog.clear()
          return
        }
        ...
        if (!text) {
          toast.show({
            message: t("tui.index.no-text-content-found-in-last-assistant-message"),
            variant: "error",
          })
          dialog.clear()
          return
        ...
        clipboard
          ...
          .catch(() => toast.show({ message: t("tui.index.failed-to-copy-to-clipboard"), variant: "error" }))
        dialog.clear()
      },
    },
    {
      title: t("tui.index.copy-session-transcript"),
      value: "session.copy",
      category: "Session",
      slash: {
        name: "copy",
      ...
      run: async () => {
        try {
          ...
          toast.show({ message: t("tui.index.failed-to-copy-session-transcript"), variant: "error" })
        }
        dialog.clear()
      },
    },
    {
      title: t("tui.index.export-session-transcript"),
      ...
      run: async () => {
        try {
          ...
          if (options.openWithoutSaving) {
            ...
            toast.show({ message: t("tui.index.session-exported-to", { filename: filename }), variant: "success" })
          }
        } catch {
          toast.show({ message: t("tui.index.failed-to-export-session"), variant: "error" })
        }
        dialog.clear()
      },
    },
    {
      title: t("tui.index.background-subagents"),
    ...
    {
      title: t("tui.index.go-to-child-session"),
    ...
    {
      title: t("tui.index.go-to-parent-session"),
    ...
    {
      title: t("tui.index.next-child-session"),
    ...
    {
      title: t("tui.index.previous-child-session"),
...
function GenericTool(props: ToolProps) {
  ...
  return (
    <Show
      ...
      fallback={
        <InlineTool icon="⚙" pending={t("tui.index.writing-command")} complete={true} part={props.part}>
...
function Shell(props: ToolProps) {
  ...
  return (
    <Switch>
      ...
      <Match when={true}>
        <InlineTool icon="$" pending={t("tui.index.writing-command")} complete={stringValue(props.input.command)} part={props.part}>
  ...
  return (
    <Switch>
      ...
      <Match when={true}>
        <InlineTool
          icon="←"
          pending={t("tui.index.preparing-write")}
...
function Glob(props: ToolProps) {
  ...
  const pathFormatter = usePathFormatter()
  return (
    <InlineTool icon="✱" pending={t("tui.index.finding-files")} complete={stringValue(props.input.pattern)} part={props.part}>
...
function Read(props: ToolProps) {
  ...
  return (
    <>
      <InlineTool
        icon="→"
        pending={t("tui.index.reading-file")}
        complete={stringValue(props.input.filePath)}
        spinner={isRunning()}
        part={props.part}
      >
...
function Grep(props: ToolProps) {
  ...
  const pathFormatter = usePathFormatter()
  return (
    <InlineTool icon="✱" pending={t("tui.index.searching-content")} complete={stringValue(props.input.pattern)} part={props.part}>
...
function WebFetch(props: ToolProps) {
          const { t } = useLanguage()
  return (
    <InlineTool icon="%" pending={t("tui.index.fetching-from-the-web")} complete={stringValue(props.input.url)} part={props.part}>
...
function WebSearch(props: ToolProps) {
    const { t } = useLanguage()
  return (
    <InlineTool icon="◈" pending={t("tui.index.searching-web")} complete={stringValue(props.input.query)} part={props.part}>
...
function Task(props: ToolProps) {
  ...
  return (
    <InlineTool
      ...
      pending={t("tui.index.delegating")}
      part={props.part}
      onClick={() => {
        if (sessionID()) {
...
function Edit(props: ToolProps) {
  ...
  return (
    <Switch>
      ...
      <Match when={true}>
        <InlineTool icon="←" pending={t("tui.index.preparing-edit")} complete={stringValue(props.input.filePath)} part={props.part}>
...
function ApplyPatch(props: ToolProps) {
  ...
  return (
    <Switch>
      ...
      <Match when={true}>
        <InlineTool icon="%" pending={t("tui.index.preparing-patch")} failure="Patch failed" complete={false} part={props.part}>
          Patch
        </InlineTool>
      </Match>
    </Switch>
  ...
  return (
    <Switch>
      ...
      <Match when={true}>
        <InlineTool
          icon="⚙"
          pending={t("tui.index.updating-todos")}
          failure={t("tui.index.todo-update-failed")}
          complete={false}
          part={props.part}
        >
          Updating todos...
...
function Question(props: ToolProps) {
  ...
  return (
    <Switch>
      ...
      <Match when={true}>
        <InlineTool icon="→" pending={t("tui.index.asking-questions")} complete={count()} part={props.part}>
...
function Skill(props: ToolProps) {
              const { t } = useLanguage()
  return (
    <InlineTool icon="→" pending={t("tui.index.loading-skill")} complete={stringValue(props.input.name)} part={props.part}>
