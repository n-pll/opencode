...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  renderer.console.onCopySelection = async (text: string) => {
    ...
    await clipboard
      .write?.(text)
      .then(() => toast.show({ message: t("tui.toast.clipboard_copied"), variant: "info" }))
      .catch(toast.error)
    ...
    batch(() => {
      ...
      if (args.model) {
        ...
        if (!providerID || !modelID)
          return toast.show({
            variant: "warning",
            message: t("tui.toast.invalid_model_format", { model: args.model }),
            duration: 3000,
          })
      ...
      if (args.fork) {
        void sdk.client.session.fork({ sessionID: match }).then((result) => {
          if (result.data?.id) {
            ...
            toast.show({ message: t("tui.toast.fork_session_failed"), variant: "error" })
          }
        })
      } else {
    ...
    [
      {
        ...
        title: t("tui.command.command.palette.show.title"),
      ...
      },
      {
        ...
        title: t("tui.command.workspace.copy_path.title"),
        category: t("tui.category.workspace"),
        ...
        run: async () => {
          ...
          await clipboard
            ...
            .then(() => toast.show({ message: t("tui.toast.worktree_path_copied"), variant: "info" }))
            .catch(toast.error)
          dialog.clear()
        },
      },
      {
        name: "workspace.list",
        title: t("tui.command.workspace.list.title"),
        category: t("tui.category.workspace"),
      ...
      ...Array.from({ length: 9 }, (_, i) => ({
        ...
        title: t("tui.command.session.quick_switch.title", { n: i + 1 }),
        category: t("tui.category.session"),
        hidden: true,
        run: () => {
      ...
      },
      {
        ...
        run: () => {
          if (local.model.variant.list().length === 0) {
            return toast.show({
              title: t("tui.toast.variant_none.title"),
              message: t("tui.toast.variant_none.message"),
              variant: "info",
            })
          }
      ...
      {
        name: "opencode.debug",
        title: t("tui.command.opencode.debug.title"),
        slashName: "debug",
        run: () => {
      ...
      },
      {
        ...
        title: mode() === "dark" ? t("tui.command.theme.switch_mode.light") : t("tui.command.theme.switch_mode.dark"),
        run: () => {
      ...
      },
      {
        ...
        title: locked() ? t("tui.command.theme.mode.unlock") : t("tui.command.theme.mode.lock"),
        run: () => {
          if (locked()) unlock()
          else lock()
          dialog.clear()
      ...
      },
      {
        ...
        title: terminalTitleEnabled()
          ? t("tui.command.terminal.title.disable")
          : t("tui.command.terminal.title.enable"),
        category: t("tui.category.system"),
        run: () => {
      ...
      },
      {
        ...
        title: kv.get("animations_enabled", true)
          ? t("tui.command.app.toggle.animations.disable")
          : t("tui.command.app.toggle.animations.enable"),
        category: t("tui.category.system"),
        run: () => {
      ...
      },
      {
        ...
        title: kv.get("file_context_enabled", true)
          ? t("tui.command.app.toggle.file_context.disable")
          : t("tui.command.app.toggle.file_context.enable"),
        category: t("tui.category.system"),
        run: () => {
      ...
      },
      {
        ...
        title:
          kv.get("diff_wrap_mode", "word") === "word"
            ? t("tui.command.app.toggle.diffwrap.disable")
            : t("tui.command.app.toggle.diffwrap.enable"),
        category: t("tui.category.system"),
        run: () => {
      ...
      },
      {
        ...
        title: pasteSummaryEnabled()
          ? t("tui.command.app.toggle.paste_summary.disable")
          : t("tui.command.app.toggle.paste_summary.enable"),
        category: t("tui.category.system"),
        run: () => {
      ...
      },
      {
        ...
        title: kv.get("session_directory_filter_enabled", true)
          ? t("tui.command.app.toggle.session_directory_filter.disable")
          : t("tui.command.app.toggle.session_directory_filter.enable"),
        category: t("tui.category.system"),
        run: async () => {
      ...
      },
      {
        ...
        title:
          local.permission.mode === "auto"
            ? t("tui.command.permission.mode.disable")
            : t("tui.command.permission.mode.enable"),
        category: t("tui.category.system"),
        run: () => {
  ...
  event.on("installation.update-available", async (evt) => {
    ...
    const choice = await DialogConfirm.show(
      dialog,
      t("tui.dialog.update_available.title"),
      t("tui.dialog.update_available.message", { version }),
      "skip",
    )
    ...
    toast.show({
      variant: "info",
      message: t("tui.toast.update_in_progress", { version }),
      duration: 30000,
    })
    ...
    if (result.error || !result.data?.success) {
      toast.show({
        variant: "error",
        title: t("tui.toast.update_failed.title"),
        message: t("tui.toast.update_failed.message"),
        duration: 10000,
      })
      return
    }
    ...
    await DialogAlert.show(
      dialog,
      t("tui.dialog.update_complete.title"),
      t("tui.dialog.update_complete.message", { version: result.data.version }),
    )
