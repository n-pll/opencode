...
export type ProtocolI18nKey = keyof typeof en
...
export const t = (key: ProtocolI18nKey, params?: I18nParams) => translate(en, active, key, params)
export const protocolLocale = locale
